...
<body data-ng-app="ngApp", data-ng-controller="ngCtrl">
    ...
    <div class="container">
    	<div class="plot"><canvas id="annualMeanEs" data-ng-click="detail('annualMeanEs')"></canvas></div>
    	<div class="plot"><canvas id="monthlyMeanEs" data-ng-click="detail('monthlyMeanEs')"></canvas></div>
    	<div class="plot"><canvas id="hourlyMeanEs" data-ng-click="detail('hourlyMeanEs')"></canvas></div>
    </div>
</body>
</html>